...
//        }
        ...
        service.initDijkstra();                                            // 1,904 (bytes) / 0,019 (nano-sec)  |||  6.736 (bytes)  / 3.955.117 (nano-sec)
        ...
        service.indexesCities();                                           // 0,952 (bytes) / 0,951 (nano-sec)  |||  9.600 (bytes)  / 6.755.709 (nano-sec)
        service.indexesRoads();                                            // 1,368 (bytes) / 0,759 (nano-sec)  |||  10.968 (bytes) / 7.514 732 (nano-sec)
        service.indexesDijkstra(2);                                        // 0,28 (bytes)  / 0,245 (nano-sec)  |||  11.248 (bytes) / 7.759.948 (nano-sec)
        service.getCitiesWay(3, 5);
        service.getCitiesWay(3, 4);
        service.getCitiesWay(3, 3);
        service.getCitiesWay(3, 6);
        service.getCitiesWay(0, 6);                                        // 0,632 (bytes) / 1,203 (nano-sec)  |||  11.880 (bytes) / 8.962.773 (nano-sec)  |||  10.376 (bytes) / 7.387.100 (nano-sec) 8 234 178  8 700 231
