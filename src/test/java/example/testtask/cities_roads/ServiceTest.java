...
//
//    private static String LOG_PROPERTIES_FILE = "src/main/resources/properties/log4j.properties";
...
//
//        log.info("--------------------[ City ]");
//        for (City city : search.cities("City")){
//            log.warn(city);
//        }
//        log.info("--------------------[ City-C ]");
//        for (City city : search.cities("City-C")){
//            log.warn(city);
//        }
//        log.info("--------------------[ City-E ]");
//        for (City city : search.cities("City-E")){
//            log.warn(city);
//        }
//        log.info("--------------------[ City-W ]");
//        for (City city : search.cities("City-W")){
//            log.warn(city);
//        }
//    }
//
...
//
//        log.info("--------------------[ #4 >> Roads ]");
//            for (Road road : search.roads(4)){
//            log.warn(road + " | " + service.getCity(road.getIdCity1()).getCoordinate() + " " + service.getCity(road.getIdCity2()).getCoordinate());
//        }
//        log.info("--------------------[ #0 >> Roads ]");
//        for (Road road : search.roads(0)) {
//            log.warn(road + " | " + service.getCity(road.getIdCity1()).getCoordinate() + " " + service.getCity(road.getIdCity2()).getCoordinate());
//        }
//        log.info("--------------------[ #7 >> Roads ]");
//        for (Road road : search.roads(7)) {
//            log.warn(road + " | " + service.getCity(road.getIdCity1()).getCoordinate() + " " + service.getCity(road.getIdCity2()).getCoordinate());
//        }
//        log.info("--------------------[ #555 >> Roads ]");
//        for (Road road : search.roads(555)) {
//            log.warn(road + " | " + service.getCity(road.getIdCity1()).getCoordinate() + " " + service.getCity(road.getIdCity2()).getCoordinate());
//        }
//    }
//
...
//        log.warn(search.delRoads("Road-1"));
//        log.info("--------------------[ 'Road-3' >> Road-Del ]");
//        log.warn(search.delRoads("Road-3"));
//
//        log.info("--------------------[ Roads-Del ]");
//        for (Road road : service.getRoads()){
//            log.warn(road + " | " + service.getCity(road.getIdCity1()).getCoordinate() + " " + service.getCity(road.getIdCity2()).getCoordinate());
...
//        log.warn(search.delCities("City-E"));
//
...
//        }
//        log.info("--------------------[ City-Y ]");
//        for (City city : search.cities("City-Y")){
//            log.warn(city);
//        }
//    }
//
...
//        for (City city : search.cities("City-A")){
//            log.warn(city);
//        }
