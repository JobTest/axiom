 ...
 *
 * {@link https://habrahabr.ru/post/237043/}
 */
public class EventQueue implements EventHandler {
    private final Deque<MyEvent> queue; //private final Queue<MyEvent> queue;
    private Handler            handler;
    private boolean          isStopped;

    public EventQueue(){
        isStopped = true;
//        queue     = new PriorityQueue<MyEvent>(16, new Comparator<MyEvent>() {
//            @Override
//            public int compare(MyEvent event1, MyEvent event2) {
//                if (event1.hashCode() == event2.hashCode())
//                    return 0;
//                else if (event1.hashCode() < event2.hashCode())
//                    return 1;
//                return -1;
//            }
//        });
