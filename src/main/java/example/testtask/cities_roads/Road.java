...
public class Road {
    /*
     * Дорога может быть уникальным либо по 'ID' либо по 'имени' либо по 'имени' и 'городам' (лучше привязываться по имени...)
     * ***
    ...
    private int   idCity1;
    private int   idCity2;
    private double weight; // граф, заданный списком ребер
    ...
    public Road(int id, String name, int idCity1, int idCity2, double weight){
        this.id      = id;
        this.name    = name;
        this.idCity1 = idCity1;
        this.idCity2 = idCity2;
