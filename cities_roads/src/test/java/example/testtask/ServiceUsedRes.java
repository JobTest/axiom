...
//        service.indexingDijkstra(service.getCities().size(), 2);           // 0,28 (bytes)  / 0,245 (nano-sec)  |||  11.248 (bytes) / 7.759.948 (nano-sec)
        ...
        service.isRoad(service.getCity(0).getId(), service.getCity(6).getId()); // 0,632 (bytes) / 1,203 (nano-sec)  |||  11.880 (bytes) / 8.962.773 (nano-sec)  |||  8.600 (bytes) / 4.956.565 (nano-sec)
