...
//    public Panel     panel1;
//    public Panel     panel2;
//    public Button[] buttons = new Button[2];   // Кнопки
//    public Label     nadpis = new Label("Введите количество вершин");
//    public TextField     tf = new TextField(); // текстовое поле
//    public String[]   names = {"Построить граф","Построить остов"};
    public int a[][], res[], x[], y[], n, i, j, lucky, k, p[], d[], min = 10000, v[], flag1 = 1, kr;
    public String r, h;
...
//        }
    ...
    public void actionPerformed2_1() {
        n     = 5; // считывается количество вершин
        init_matr();
        flag1 = 1;
        repaint();
    }
    public void actionPerformed2_2() {
        d_p();
        flag1 = 0;
        repaint();
    }
